...
/********************************************************
 * InterbotiX PhantomX Hexapod  Test / Diagnostic Code                                           
 *
 *
 ...
 *  http://learn.trossenrobotics.com/interbotix/robot-crawlers/10-phantomx-hexapod/29-phantomx-hexapod-build-check
 *  
 *  Robot  Getting Started Guide
 *  http://learn.trossenrobotics.com/10-interbotix/crawlers/phantomx-hexapod/100-phantomx-hexapod-getting-started.html
 *  WIRING
 *      Power Jumper should be set to VIN    
 *      
 *      12v power supply should be connected to the ArbotiX
 * 
 *      18 AX-12As or AX-18As should be daisy chained to the ArbotiX-M board
 *
...
const int SERVOCOUNT = 18;  //number of servos in this robot
...
{    
  int inByte = Serial.read(); //read data from serial port for menu option
    ...
    case '8':
      dxlRegisterReportMultiple(SERVOCOUNT);
      MenuOptions();
      break;
