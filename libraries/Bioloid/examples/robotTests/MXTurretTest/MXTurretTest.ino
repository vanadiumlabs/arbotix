...
/********************************************************
 * InterbotiX WidowX/ScoprionX Turret Test / Diagnostic Code
 * 
 *
 ...
 *   http://learn.trossenrobotics.com/interbotix/robot-turrets/14-widowx-robot-turret/23-widowx-robot-turret-build-check
 ...
 * 
 *      2 MX-28Ts or 2 MX-64ts should be daisy chained to the ArbotiX-M board
 *
...
void loop(){
    ...
    case '8':
      dxlRegisterReportMultiple(SERVOCOUNT); //print out all register data to the serial port
      MenuOptions();                 //show menu options
      break;
