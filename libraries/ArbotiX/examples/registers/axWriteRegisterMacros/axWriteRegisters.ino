/***********************************************************************************
 *   ___________          DYNAMIXEL AX Write Registers
 *  *|  /    \  |*
 *  *| |      | |*
 *  *|  \ __ /  |*
 *  *|          |*
...
void setup()
{
  ...
  delay(33);
  dxlSetCCWAngleLimit(SERVO_ID, 1023);        //set counter clockwise angle limit
  delay(33);
  ...
  delay(33);
  axSetCCWComplainceMargin(SERVO_ID, 1);         //set CCW Compliance Margin for servo , see manual for more info
  delay(33);
  axSetCWComplainceMargin(SERVO_ID, 1);          //set CW Compliance Margin for servo , see manual for more info
  delay(33);
  axSetCCWComplainceSlope(SERVO_ID, 32);          //set CCW Compliance Slope for servo , see manual for more info
  delay(33);
  axSetCWComplainceSlope(SERVO_ID, 32);           //set CW Compliance Slope for servo , see manual for more info
  delay(33);
  dxlSetGoalPosition(SERVO_ID, 512);           //set goal position , see manual for more info           
  delay(33);
